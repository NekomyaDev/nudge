...
Pre-alpha. The language design is complete ([docs/design.md](docs/design.md), v1.1); the compiler is under active development ([docs/roadmap.md](docs/roadmap.md)). Currently at **day 1–3 of the MVP plan**: lexer done, parser next.
